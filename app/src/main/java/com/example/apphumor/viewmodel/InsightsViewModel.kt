...
import com.example.apphumor.utils.HumorUtils // Importação do novo utilitário
...
class InsightsViewModel(
    ...
    private fun calculateInsights(notes: List<HumorNote>, range: TimeRange): List<Insight> {
        ...
        // Recupera o nome original capitalizado para passar para o Utils
        val mostCommonHumorRaw = mostCommonEntry?.key?.replaceFirstChar { it.titlecase() } ?: "Neutro"

        // USANDO O UTILITÁRIO DRY AQUI
        ...
        return listOf(
            Insight(
                ...
                backgroundColorResId = moodStyle.backgroundColorRes // Aqui usamos a cor de fundo!
            ),
            Insight(
